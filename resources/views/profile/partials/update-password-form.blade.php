<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            {{ __('Aggiorna la tua password') }}
        </h2>

        <p class="mt-1 text-sm text-gray-600">
            {{ __('Assicurati di utilizzare una password lunga e sicura.') }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="password_confirmation" :value="__('Conferma la password')" />
